...
//             nameText.GetComponent<RectTransform>().anchorMax = new Vector2(PlayerId == GameLobbyManager.Instance.Lobby.HostId ? 0.85f : 1f, 1f);
...
//         {
//             inGameStatePanel.SetActive(inGame);
//         }
